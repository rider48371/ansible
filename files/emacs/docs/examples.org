...
- Doom's [[module:][:lang emacs-lisp]] module installs the [[package:elisp-demos]] package. This displays
  usage examples alongside documentation in [[package:help]] and [[package:helpful]] buffers (produced
  by =describe-*= and =helpful-*= commands; e.g. [[kbd:][<help> h f]]). Doom has extended this
  package to search this file as well.
